    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { original: "Sol", translation: "Sun" },
            { original: "Luna", translation: "Moon" },
            { original: "Stellae", translation: "Stars" },
            { original: "Crepusculum", translation: "Twilight" },
            { original: "Invisibilia", translation: "Invisible" },
            { original: "Aliena", translation: "Alien" },
            { original: "Lacerta", translation: "Lizard" },
            { original: "Homines", translation: "People" },
          ],
        };
        return supertest(app)
          .post("/api/user")
